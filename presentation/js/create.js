...
( function() {
	...
	var slides = [
		...
		{ h : "Components" , t : "Components combine markup (HTML) and logic (JS) in the same file, challenging traditional approaches. <span>A separation of concerns?</span>" },
		...
		{ h : "Angular" , t : "Javascript framework created by Google. Provides everything: router, HTTP services, forms, testing." },
		{ h : "Angular" , t : "Make use of Reactive programming techniques: Observables." },
		{ h : "React" , t : "Javascript framework created by Facebook. Minimal approach." },
